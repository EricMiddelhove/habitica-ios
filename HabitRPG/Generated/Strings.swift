...
public enum L10n {
  ...
  public enum Faint {
    ...
    /// You’ll drop to **level %s, lose %s Gold, and break a piece of gear**… You can earn them all back with hard work!
  ...
  public enum GiftOneGetOneData {
    ...
    public static func purchaseBannerTitle(_ p1: String) -> String {
      return L10n.tr("Mainstrings", "gift_one_get_one_data.purchase_banner_title", p1)
    }
  }
  ...
  public enum Items {
    ...
    /// Check out the Market to buy food or a Saddle to instantly raise your Pet!
    public static var footerFoodDescription: String { return L10n.tr("Mainstrings", "items.footer_food_description") }
    /// Not getting the right food from tasks?
    public static var footerFoodTitle: String { return L10n.tr("Mainstrings", "items.footer_food_title") }
  ...
  public enum Settings {
    ...
    /// You will lose all your levels, Gold, and Experience. All your tasks and their historical data will be deleted (Challenge tasks will stay). You will lose all equipment, except Subscriber items and free commemorative items, but you will be able to buy it back. You will need to be the correct class to re-buy class-specific gear. You will keep your current class, Achievements, and your Pets and Mounts. If you’re absolutely certain, type RESET into the text box below.
  ...
  public enum Shops {
    ...
    public static func purchasedAllGear(_ p1: Int) -> String {
      return L10n.tr("Mainstrings", "shops.purchased_all_gear", p1)
    }
    /// New gear is released during the seasonal Galas. The Enchanted Armoire gets new stock every month too!
    public static var purchasedAllGearArmoireEmpty: String { return L10n.tr("Mainstrings", "shops.purchased_all_gear_armoire_empty") }
    /// You own all %@ Gear
